...
class AlgoConfig(StrictDataClass):
    ...
    use_auxiliary_loss: bool = False  # constrained training with auxiliary loss
    auxiliary_loss_type: str = "none"  # type of auxiliary loss
    filter_unsynthesizable: bool = False  # filter unsynthesizable molecules
    auxiliary_loss_weight: float = 0.001  # weight of auxiliary loss
    use_reward_shaping: bool = False  # reward shaping with auxiliary loss
    use_retrosynthesis: bool = False  # use retrosynthesis
    retro_env: str = "stock"  # environment for retrosynthesis
    max_retro_steps: int = 3  # maximum number of steps for retrosynthesis
